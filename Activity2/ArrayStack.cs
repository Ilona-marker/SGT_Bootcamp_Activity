...
namespace CSharp.Activity.Datastore
{
    public class ArrayStack<T> : ArrayBase<T>
    {
        ...
        public virtual void Push(T arg)
        {
            ...
            if (Contains(arg) || this.IsFull())
            {
                throw new InvalidOperationException("Impossible to add.");
            }

            int newIndex = this.Add(arg);
            if (newIndex == NOT_IN_STRUCTURE)
            {
                throw new InvalidOperationException("Impossible to add.");
            }
        }
        ...
        public virtual T Pop()
        {
            ...
            if (IsEmpty())
            {
                throw new InvalidOperationException("Impossible to pop.");
            }
        ...
        public virtual T Peek()
        {
            ...
            if (IsEmpty())
            {
                throw new InvalidOperationException("Impossible to peek.");
            }

            return this[Count - 1]; // in the final solution this statement should be deleted or modified
        }
    }
}